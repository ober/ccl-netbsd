...
;;; On Netbsd, the C compiler returns small structures in registers
;;; (just like on Darwin, apparently).
(defun x86-netbsd32::record-type-returns-structure-as-first-arg (rtype)
  (when (and rtype
...
(defun x86-netbsd32::expand-ff-call (callform args &key (arg-coerce #'null-coerce-foreign-arg) (result-coerce #'null-coerce-foreign-result))
  (x8632::expand-ff-call callform args :arg-coerce arg-coerce :result-coerce result-coerce))

(defun x86-netbsd32::generate-callback-bindings (stack-ptr fp-args-ptr argvars argspecs result-spec struct-result-name)
  (x8632::generate-callback-bindings stack-ptr fp-args-ptr argvars argspecs result-spec struct-result-name))

(defun x86-netbsd32::generate-callback-return-value (stack-ptr fp-args-ptr result return-type struct-return-arg)
